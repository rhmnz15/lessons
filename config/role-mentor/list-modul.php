                                        ...
                                        <div class="py-6 px-5 lg:px-5">
                                            ...
                                            <form class="space-y-2 form-prevent" onsubmit="postModul();return false">
                                                ...
                                                <!-- <div class="batch-id mt-2  hidden">
                                                    ...
                                                    <select name="batch_id" id="batch-id1" class="bg-gray-50 border  whitespace-normal  border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
