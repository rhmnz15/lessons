               ...
               <li id="bantuSub1">
                  <span class="caret flex bg-gray-100 shadow-sm p-2 rounded items-center ml-3 mt-2 mb-2">
                     ...
                     <div class="grid sm:grid-cols-3 lg:grid-cols-3 sm:grid-cols-1 md:grid-cols-1 gap-1">
                        ...
                        <a onclick="javascript:loadin();"  href="edit.php?modulId=<?= $sub1["id"]; ?>" id="bantu06" class="flex text-white bg-gradient-to-t from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg  sm:text-sm  text-xs text-center  items-center justify-center py-1 px-2 text-center space-y-1">
