...
// $curl1 = curl_init();
// $datal1 = 'https://account.lumintulogic.com/api/batch.php' . $_GET['modulId'];
// curl_setopt($curl1, CURLOPT_URL, $datal1);
// curl_setopt($curl1, CURLOPT_RETURNTRANSFER, true);
// $datach1 = curl_exec($curl1);
// if ($check1 = curl_error($curl1)) {
//     echo $check1;
// } else {
//     $getData1 = json_decode($datach1, true);
// }
// curl_close($curl1);
