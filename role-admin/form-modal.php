                    ...
                    <div class="py-6 px-6 lg:px-8">
                        ...
                        <form class="space-y-2 form-prevent1" action="" onsubmit="updateModul(<?= $modul['id']; ?>)" method="POST">
                            ...
                            <div class="batch-id mt-2">
                                ...
                                <select name="batch_id1" id="batch-id1" class="overflow-y whitespace-normal bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
                                    <!-- <option selected value="">- Pilih Satu -</option> -->
                                    <?php foreach ($take1["batch"] as $bid) : ?>
                                        <option class="overflow-y" value="<?= $bid["batch_id"]; ?>"> <?= $bid["batch_name"]; ?> | <?= $bid["batch_start_date"]; ?> | <?= $bid["batch_end_date"]; ?> </option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
