...
<body>
    ...
    <div class="flex items-center">
                    ...
                    <div class="sm:mt-[45px] sm:hidden md:hidden hidden sm:block md:block lg:block   ml-10 mb-4" id="bantutreeview">
                        <table class="sm:w-full  text-sm text-left text-gray-500  ">
                            <thead class="text-lg text-black bg-gray-200  ">
                                <tr>
                                    <!-- tree view yang ada di tambah ada di bagaian kanan -->
                            ...
                            <tbody>
                                <!-- lokasi tree view kita lakukan include untuk tambah materi -->
                                <?php
        ...
        <!-- loading animasi saat klik tambah -->
        ...
        <!-- modal untuk konfirmasi bahwa user akan keluar atau tidak -->
    ...
    <!-- scrip dan library yang digunakan -->
    ...
    <script>
        ...
        // javascript untuk mengatur start date dan end date    
        ...
        // script IntroJS agar otomatis menyala saat memasuki halaman tambah
        const intro = introJs();
        intro.setOptions({
            steps: [{
        ...
        // bagian mengaktifkan togl side bar
